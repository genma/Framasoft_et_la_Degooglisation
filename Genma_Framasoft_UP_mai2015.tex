...
%----------------------------------------------------------------------------------------
\begin{frame}
\Huge{\centerline{Nous vivons dans}}
...
\end{block}
Pius de détails sur \url{http://degooglisons-internet.org/}
\end{frame}
...
Selon une étude réalisée par la CNIL et ses homologues européennes, avec l'examen de plus de 1200 applications mobiles,
 les trois quarts des applis installées sur les smartphones collectent des données personnelles, et la plupart le font avec une information insuffisante du consommateur.
}
Source \url{http://www.numerama.com}
\end{block}
Est-il normal qu'une application lampe de poche ait besoin d'accéder au carnet d'adresses?
\end{frame}
...
\begin{block}{Présentation de Google Flu sur leur site}
\begin{itemize}
\justifying{
...
\item Tous les publicités, Amazon...
\end{itemize}
\end{block}
}
\begin{center}
...
\end{block}
Plus de détails sur \url{http://www.framasoft.org}
\end{frame}
...
\justifying{
\begin{itemize}
\item 12 ans d’existence, 1 association et 3 permanents
\item 1 réseau, 1 000 000 visites par mois
\item 25 projets, 30 serveurs, 60 noms de domaine et 30 CMS déployés
\item 15 000 abonnés Twitter
...
\\~\\
\url{http://participer.framasoft.org}
\end{block}
\end{frame}
